...
class TrainerProgress(Progress):
    def __init__(self, 
        ...
        self.trainer_tasks = {
            ...
            'train-fair': self.add_task(total=num_train_steps, metrics='', unit='steps', description='training_fair',
                                        visible=False),
            'val-fair': self.add_task(total=num_val_steps, metrics='', unit='steps', description='val_fair',
                                      visible=False),
